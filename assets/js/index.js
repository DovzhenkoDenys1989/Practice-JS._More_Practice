...
function sum(n){
 ...
 /* function sum(n) {
  ...
  class Student{
   ...
   const student1 = new Student("Bob", "Smith", true, "Ukraine, Kiev", university);
   const student2 = new Student("Kate", "Willis", false, "Ukraine, Zaporizhzhia", university);


   function studentInfo(student){
    console.log (` Name:${student.name}\n Surname:${student.surname}\n Gender:${student.isMale ? 'Male' : 'Woman'} \n Contact:${student.contact}\n Faculty:${student.faculty}\n Chair:${student.chair}`);
   }
...
const book = new Book("Stiven King", "About nature", 2021, "UniversCompany");
const eBook = new ElectronicBook("Felicity O`Dell", "English vocabulary in use", 2017, "Cambridge University Press", "A2", 9781316631539);
